...
class AIPN_Advanced_Settings {
	...
	private function get_visibility_fields(): array {
		return array(
			...
			array(
				'title'             => __( 'Minimum Cart Value', 'ai-price-negotiator-for-woocommerce' ),
				'id'                => 'aipn_visibility_min_cart',
				'type'              => 'number',
				'desc'              => __( 'Only show widget if cart total is at least this amount.', 'ai-price-negotiator-for-woocommerce' ),
				'default'           => '',
				'placeholder'       => __( 'No minimum', 'ai-price-negotiator-for-woocommerce' ),
				'custom_attributes' => array(
					'min'  => '0',
					'step' => '1',
				),
			...
			array(
				'title'             => __( 'Maximum Cart Value', 'ai-price-negotiator-for-woocommerce' ),
				'id'                => 'aipn_visibility_max_cart',
				'type'              => 'number',
				'desc'              => __( 'Hide widget if cart total exceeds this amount.', 'ai-price-negotiator-for-woocommerce' ),
				'default'           => '',
				'placeholder'       => __( 'No maximum', 'ai-price-negotiator-for-woocommerce' ),
				'custom_attributes' => array(
					'min'  => '0',
					'step' => '1',
				),
			...
			array(
				'title'             => __( 'Minimum Cart Items', 'ai-price-negotiator-for-woocommerce' ),
				'id'                => 'aipn_visibility_min_qty',
				'type'              => 'number',
				'desc'              => __( 'Only show widget if cart has at least this many unique items.', 'ai-price-negotiator-for-woocommerce' ),
				'default'           => '',
				'placeholder'       => __( 'No minimum', 'ai-price-negotiator-for-woocommerce' ),
				'custom_attributes' => array(
					'min'  => '1',
			...
			array(
				'title'             => __( 'Minimum Past Orders', 'ai-price-negotiator-for-woocommerce' ),
				'id'                => 'aipn_visibility_min_orders',
				'type'              => 'number',
				'desc'              => __( 'Only show to customers who have placed at least this many orders. (Logged-in only)', 'ai-price-negotiator-for-woocommerce' ),
				'default'           => '',
				'placeholder'       => __( 'No minimum', 'ai-price-negotiator-for-woocommerce' ),
				'custom_attributes' => array(
					'min'  => '0',
			...
			array(
				'title'             => __( 'Minimum Lifetime Spend', 'ai-price-negotiator-for-woocommerce' ),
				'id'                => 'aipn_visibility_min_spent',
				'type'              => 'number',
				'desc'              => __( 'Only show to customers who have spent at least this amount in total. (Logged-in only)', 'ai-price-negotiator-for-woocommerce' ),
				'default'           => '',
				'placeholder'       => __( 'No minimum', 'ai-price-negotiator-for-woocommerce' ),
				'custom_attributes' => array(
					'min'  => '0',
			...
			array(
				'title'       => __( 'Allowed User Roles', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_user_roles',
				'type'        => 'text',
				'desc'        => __( 'Comma-separated list of user roles (e.g., <code>customer, wholesale, subscriber</code>). Leave empty for all roles.', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => __( 'All roles', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 300px;',
			),
			array(
				'title'       => __( 'Product Categories (Include)', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_categories',
				'type'        => 'text',
				'desc'        => __( 'Only show if cart contains items from these category slugs. Comma-separated (e.g., <code>electronics, clothing</code>). Leave empty for all categories.', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => __( 'All categories', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 300px;',
			),
			array(
				'title'       => __( 'Excluded Categories', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_excluded_categories',
				'type'        => 'text',
				'desc'        => __( 'Hide widget if cart contains any item from these category slugs. Comma-separated (e.g., <code>gift-cards, sale</code>).', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => __( 'None excluded', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 300px;',
			),
			array(
				'title'       => __( 'Schedule — Days', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_schedule_days',
				'type'        => 'text',
				'desc'        => __( 'Show widget only on these days. Comma-separated (e.g., <code>mon, tue, wed, thu, fri</code>). Leave empty for every day.', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => __( 'Every day', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 300px;',
			),
			array(
				'title'       => __( 'Schedule — Start Time', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_schedule_start',
				'type'        => 'text',
				'desc'        => __( 'Show widget starting at this time (24h format, e.g., <code>09:00</code>). Uses your WordPress timezone.', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => '00:00',
				'css'         => 'width: 80px;',
			),
			array(
				'title'       => __( 'Schedule — End Time', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_schedule_end',
				'type'        => 'text',
				'desc'        => __( 'Hide widget after this time (24h format, e.g., <code>17:00</code>). Uses your WordPress timezone.', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => '23:59',
				'css'         => 'width: 80px;',
			),
			array(
				'title'       => __( 'Allowed Countries', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_visibility_countries',
				'type'        => 'text',
				'desc'        => __( 'Only show to customers from these countries. Comma-separated ISO codes (e.g., <code>US, GB, IN, CA</code>). Uses billing country or geolocation.', 'ai-price-negotiator-for-woocommerce' ),
				'default'     => '',
				'placeholder' => __( 'All countries', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 300px;',
			),
			array(
	...
	private function get_header_cta_fields(): array {
		return array(
			...
			array(
				'title'   => __( 'Header Background', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_header_bg_color',
				'type'    => 'text',
				'desc'    => __( 'Background color for the chat header. Empty = Primary Color.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'Header Text Color', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_header_text_color',
				'type'    => 'text',
				'desc'    => __( 'Text and icon color in the chat header.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '#ffffff',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'CTA Background', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_cta_bg_color',
				'type'    => 'text',
				'desc'    => __( 'Background color for the collapsed CTA banner.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'CTA Text Color', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_cta_text_color',
				'type'    => 'text',
				'desc'    => __( 'Text color for the CTA title and subtitle.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'CTA Button Color', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_cta_btn_bg_color',
				'type'    => 'text',
				'desc'    => __( 'Background color for the "Make an Offer" button. Empty = Primary Color.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'CTA Button Text', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_cta_btn_text_color',
				'type'    => 'text',
				'desc'    => __( 'Text color for the CTA button.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '#ffffff',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
	...
	private function get_layout_fields(): array {
		return array(
			...
			array(
				'title'   => __( 'Chat Background', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_widget_bg_color',
				'type'    => 'text',
				'desc'    => __( 'Background color for the chat messages area.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'Send Button Color', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_send_btn_color',
				'type'    => 'text',
				'desc'    => __( 'Background color for the send button. Empty = Primary Color.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
			array(
				'title'   => __( 'Widget Border Color', 'ai-price-negotiator-for-woocommerce' ),
				'id'      => 'aipn_widget_border_color',
				'type'    => 'text',
				'desc'    => __( 'Border color for the widget container and dividers.', 'ai-price-negotiator-for-woocommerce' ),
				'default' => '#e5e7eb',
				'class'   => 'aipn-color-picker',
				'css'     => 'width: 80px;',
			),
