		...
		<div class="wrap aipn-analytics-wrap">
			...
			<div class="aipn-analytics-section">
				...
				<div class="aipn-outcomes-card">
					...
					$statuses = array(
						'accepted'  => array(
							'label' => __( 'Accepted', 'ai-price-negotiator-for-woocommerce' ),
							'color' => 'green',
						),
						'expired'   => array(
							'label' => __( 'Expired', 'ai-price-negotiator-for-woocommerce' ),
							'color' => 'yellow',
						),
						'abandoned' => array(
							'label' => __( 'Abandoned', 'ai-price-negotiator-for-woocommerce' ),
							'color' => 'gray',
						),
					);
						...
						<tbody>
							...
							<?php else : ?>
								...
								<tr>
									...
									if ( $row['coupon_code'] ) :
										?>
										<span class="aipn-coupon-code"><?php echo esc_html( $row['coupon_code'] ); ?></span>
										<?php
else :
	?>
	—<?php endif; ?></td>
