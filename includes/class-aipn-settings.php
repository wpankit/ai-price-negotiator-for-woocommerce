...
class AIPN_Settings {
	...
	private function get_text_fields(): array {
		return array(
			...
			array(
				'title'       => __( 'CTA Heading', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_cta_title',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Want a better deal?', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 350px;',
			),
			array(
				'title'       => __( 'CTA Subtitle', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_cta_subtitle',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Make an offer on your cart', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 350px;',
			),
			array(
				...
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Make an Offer', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 250px;',
			),
			array(
				'title'       => __( 'Chat Header Title', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_chat_header',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Price Negotiation', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 250px;',
			),
			array(
				'title'       => __( 'Input Placeholder', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_input_placeholder',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Type your offer or message...', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 350px;',
			),
			array(
				'title'       => __( 'Deal Accepted Text', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_deal_message',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Deal accepted!', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 250px;',
			),
			array(
				'title'       => __( 'Sending Text', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_sending_text',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Negotiating...', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 250px;',
			),
			array(
				'title'       => __( 'Error Message', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_error_message',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'Something went wrong. Please try again.', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 350px;',
			),
			array(
				'title'       => __( 'AI Notice', 'ai-price-negotiator-for-woocommerce' ),
				'id'          => 'aipn_ai_notice',
				'type'        => 'text',
				'default'     => '',
				'placeholder' => __( 'You\'re chatting with an AI assistant.', 'ai-price-negotiator-for-woocommerce' ),
				'css'         => 'width: 350px;',
				'desc_tip'    => __( 'Shown at the top of the chat, so shoppers know they are talking to an AI.', 'ai-price-negotiator-for-woocommerce' ),
			),
			array(
				'type' => 'sectionend',
				'id'   => 'aipn_widget_text_settings',
